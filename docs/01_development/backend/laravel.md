...
- [Installer Composer](../others/web_development_php.md#composer)
- [Installer le serveur web Apache pour php](../others/web_development_php.md#apache)
...
- [Source](../database/migrations_and_seeders_by_tanvir.md)
